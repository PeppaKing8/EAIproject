...
for i in {1..5}; do
    python train_rgbd.py --env-id PushCube-v1  --demo-path ~/.maniskill/demos/PushCube-v1/motionplanning/trajectory.rgbd.pd_ee_delta_pos.cpu.h5   --control-mode "pd_ee_delta_pos" --sim-backend "gpu" --num-demos 100 --max_episode_steps 300   --total_iters 20100   --num-eval-envs 100 --seed $i --track
done